...
{
    public class WithNoYamlHeaderAndNoH1AndNestedSlugTheLastPartOfTheSlugIsHumanisedForTheTitle
    {
        private Frankengenerator _generator;
        private InMemoryFrankenstore _store;
        private Frankenpage _page;
        private const string Slug = "nested/with-no-yaml-header-and-no-h1s";
